...
When contributing to "Anarcho Notepad" you have to follow some conventions and a simple workflow. It allows me to handle the requests quickly and ensure best quality
for the "Anarcho Notepad" core code.
...
- "Anarcho Notepad" is maintained by me. I don't owe you anything, so be polite. Reports with an indignant or belligerent tone tend to be moved to the bottom of the pile.
...
- Mention which release of "Anarcho Notepad" you're using.
...
By contributing code to "Anarcho Notepad" you:
